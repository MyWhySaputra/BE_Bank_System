...
const {
  ...
  AdminDelete,
  Delete,
} = require("../../controllers/v1/bankAccountController");
const { Auth, Admin, midd_id } = require("../../middlewares/v1/authMiddleware");
...
} = require("../../middlewares/v1/bankAccountMiddleware");
